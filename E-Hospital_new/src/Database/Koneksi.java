...
public class Koneksi {
    ...
    public static List<User_Mod> GetData(){
        try{
            ArrayList<User_Mod> userList = new ArrayList<User_Mod>();
            conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASS);
            stmt = conn.createStatement();
            ...
            while(rs.next()){
                userList.add(new User_Mod(rs.getString("ID_PASIEN"), rs.getString("NAMA_PASIEN"), rs.getString("EMAIL_PASIEN")
